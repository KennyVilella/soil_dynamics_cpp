...
TEST(UnitTestIntersectingCells, MoveBodySoil) {
    ...
    auto pos0 = soil_simulator::CalcBodyFramePos(10, 15, 0.7, grid, bucket);
    auto pos2 = soil_simulator::CalcBodyFramePos(10, 15, 0.0, grid, bucket);
    ...
    posA = soil_simulator::CalcBodyFramePos(5, 7, 0.2, grid, bucket);
    std::tie(ind, ii, jj, h_soil, wall_presence) = soil_simulator::MoveBodySoil(
        sim_out, 2, 10, 15, 0.3, 5, 7, 0.6, false, grid, bucket, 1e-5);
    EXPECT_EQ(wall_presence, false);
    EXPECT_NEAR(h_soil, 0.0, 1e-5);
    ...
    posA = soil_simulator::CalcBodyFramePos(5, 7, 0.1, grid, bucket);
    ...
    posA = soil_simulator::CalcBodyFramePos(5, 7, 0.6, grid, bucket);
    ...
    posA = soil_simulator::CalcBodyFramePos(5, 7, 0.0, grid, bucket);
    std::tie(ind, ii, jj, h_soil, wall_presence) = soil_simulator::MoveBodySoil(
        sim_out, 2, 10, 15, 0.3, 5, 7, 0.6, false, grid, bucket, 1e-5);
    EXPECT_EQ(wall_presence, false);
    EXPECT_NEAR(h_soil, 0.0, 1e-5);
...
TEST(UnitTestIntersectingCells, MoveIntersectingBodySoil) {
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.5);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.2, grid, bucket);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    CheckHeight(sim_out, 10, 15, NAN, 0.3, 0.5, 0.6, 0.7);
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.5);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    pos0 = soil_simulator::CalcBodyFramePos(11, 15, 0.7, grid, bucket);
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.5);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.1, grid, bucket);
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.5);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    pos2 = soil_simulator::CalcBodyFramePos(11, 15, 0.5, grid, bucket);
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.1);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.5);
    pos0 = soil_simulator::CalcBodyFramePos(11, 15, 1.0, grid, bucket);
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.1);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.5);
    pos0 = soil_simulator::CalcBodyFramePos(11, 15, 0.5, grid, bucket);
    PushBodySoilPos(sim_out, 0, 11, 15, pos0, 0.1);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    CheckHeight(sim_out, 10, 15, NAN, 0.6, 0.7, 0.3, 0.5);
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.1);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.5);
    pos2 = soil_simulator::CalcBodyFramePos(11, 15, 1.0, grid, bucket);
    ...
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.2, grid, bucket);
    posB = soil_simulator::CalcBodyFramePos(12, 15, 0.2, grid, bucket);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    CheckHeight(sim_out, 10, 15, NAN, 0.3, 0.5, 0.6, 0.7);
    CheckHeight(sim_out, 11, 15, NAN, 0.2, 0.3, NAN, NAN);
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.5);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.4, grid, bucket);
    posB = soil_simulator::CalcBodyFramePos(12, 15, 0.1, grid, bucket);
    ...
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.2, grid, bucket);
    posB = soil_simulator::CalcBodyFramePos(12, 15, 0.2, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(12, 15, 0.8, grid, bucket);
    ...
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.2, grid, bucket);
    pos0 = soil_simulator::CalcBodyFramePos(12, 15, 0.2, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(12, 15, 0.8, grid, bucket);
    ...
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.2, grid, bucket);
    pos0 = soil_simulator::CalcBodyFramePos(12, 15, 0.8, grid, bucket);
    posB = soil_simulator::CalcBodyFramePos(12, 15, 0.2, grid, bucket);
    PushBodySoilPos(sim_out, 0, 12, 15, pos0, 0.1);
    PushBodySoilPos(sim_out, 2, 12, 15, posB, 0.1);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    ...
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.2, grid, bucket);
    pos0 = soil_simulator::CalcBodyFramePos(12, 15, 0.8, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(12, 15, 0.2, grid, bucket);
    PushBodySoilPos(sim_out, 0, 12, 15, pos0, 0.1);
    PushBodySoilPos(sim_out, 2, 12, 15, pos2, 0.1);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    CheckHeight(sim_out, 10, 15, NAN, 0.3, 0.5, 0.6, 0.7);
    ...
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.1, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(11, 15, 0.7, grid, bucket);
    PushBodySoilPos(sim_out, 0, 11, 15, posA, 0.1);
    PushBodySoilPos(sim_out, 2, 11, 15, pos2, 0.2);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    CheckHeight(sim_out, 10, 15, NAN, 0.3, 0.5, 0.6, 0.7);
    ...
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.1, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(11, 15, 0.8, grid, bucket);
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.5);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.3, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(11, 15, 0.8, grid, bucket);
    PushBodySoilPos(sim_out, 0, 11, 15, posA, 0.1);
    PushBodySoilPos(sim_out, 2, 11, 15, pos2, 0.1);
    posB = soil_simulator::CalcBodyFramePos(12, 15, 0.3, grid, bucket);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    CheckHeight(sim_out, 10, 15, NAN, 0.3, 0.5, 0.6, 0.7);
    ...
    PushBodySoilPos(sim_out, 0, 11, 15, posA, 0.5);
    PushBodySoilPos(sim_out, 2, 11, 15, pos2, 0.1);
    posB = soil_simulator::CalcBodyFramePos(12, 15, 0.4, grid, bucket);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    CheckHeight(sim_out, 10, 15, NAN, 0.3, 0.5, 0.6, 0.7);
    CheckHeight(sim_out, 11, 15, NAN, 0.1, 0.7, 0.8, 0.9);
    ...
    PushBodySoilPos(sim_out, 2, 11, 15, pos2, 0.1);
    posB = soil_simulator::CalcBodyFramePos(12, 15, 0.2, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(12, 15, 0.9, grid, bucket);
    PushBodySoilPos(sim_out, 0, 12, 15, posB, 0.1);
    ...
    PushBodySoilPos(sim_out, 0, 11, 15, posA, 0.5);
    PushBodySoilPos(sim_out, 2, 11, 15, pos2, 0.1);
    pos0 = soil_simulator::CalcBodyFramePos(12, 15, 0.9, grid, bucket);
    posB = soil_simulator::CalcBodyFramePos(12, 15, 0.2, grid, bucket);
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.5);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    pos0 = soil_simulator::CalcBodyFramePos(11, 15, 0.1, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(11, 15, 0.7, grid, bucket);
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.5);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    pos0 = soil_simulator::CalcBodyFramePos(11, 15, 0.3, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(11, 15, 0.8, grid, bucket);
    PushBodySoilPos(sim_out, 0, 11, 15, pos0, 0.2);
    PushBodySoilPos(sim_out, 2, 11, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(12, 15, 0.3, grid, bucket);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    CheckHeight(sim_out, 10, 15, NAN, 0.3, 0.5, 0.6, 0.7);
    CheckHeight(sim_out, 12, 15, NAN, 0.3, 0.6, NAN, NAN);
    EXPECT_NEAR(sim_out->body_soil_pos_[0].h_soil, 0.2, 1.e-5);
    ...
    PushBodySoilPos(sim_out, 0, 11, 15, pos0, 0.6);
    PushBodySoilPos(sim_out, 2, 11, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(12, 15, 0.4, grid, bucket);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    CheckHeight(sim_out, 10, 15, NAN, 0.3, 0.5, 0.6, 0.7);
    ...
    PushBodySoilPos(sim_out, 0, 11, 15, pos0, 0.6);
    PushBodySoilPos(sim_out, 2, 11, 15, pos2, 0.1);
    posA = soil_simulator::CalcBodyFramePos(12, 15, 0.2, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(12, 15, 0.9, grid, bucket);
    PushBodySoilPos(sim_out, 0, 12, 15, posA, 0.1);
    PushBodySoilPos(sim_out, 2, 12, 15, pos2, 0.4);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    ...
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.5);
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    pos0 = soil_simulator::CalcBodyFramePos(11, 15, 0.8, grid, bucket);
    posA = soil_simulator::CalcBodyFramePos(11, 15, 0.1, grid, bucket);
    PushBodySoilPos(sim_out, 0, 11, 15, pos0, 0.1);
    ...
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    pos0 = soil_simulator::CalcBodyFramePos(11, 15, 0.7, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(11, 15, 0.1, grid, bucket);
    PushBodySoilPos(sim_out, 0, 11, 15, pos0, 0.2);
    PushBodySoilPos(sim_out, 2, 11, 15, pos2, 0.3);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    CheckHeight(sim_out, 10, 15, NAN, 0.3, 0.5, 0.6, 0.7);
    ...
    PushBodySoilPos(sim_out, 2, 10, 15, pos2, 0.1);
    pos0 = soil_simulator::CalcBodyFramePos(11, 15, 0.8, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(11, 15, 0.3, grid, bucket);
    PushBodySoilPos(sim_out, 0, 11, 15, pos0, 0.1);
    PushBodySoilPos(sim_out, 2, 11, 15, pos2, 0.2);
    posA = soil_simulator::CalcBodyFramePos(12, 15, 0.3, grid, bucket);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
    ...
    pos0 = soil_simulator::CalcBodyFramePos(10, 15, 0.3, grid, bucket);
    pos2 = soil_simulator::CalcBodyFramePos(10, 15, 0.9, grid, bucket);
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.2);
    PushBodySoilPos(sim_out, 0, 10, 15, pos0, 0.1);
    ...
    posB = soil_simulator::CalcBodyFramePos(11, 16, 0.1, grid, bucket);
    posC = soil_simulator::CalcBodyFramePos(11, 14, 0.1, grid, bucket);
    soil_simulator::MoveIntersectingBodySoil(sim_out, grid, bucket, 1e-5);
